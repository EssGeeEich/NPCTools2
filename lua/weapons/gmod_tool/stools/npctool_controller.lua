...
if(CLIENT) then
	...
	language.Add("tool.npctool_controller.left","De/Select a NPC or move the selected NPC move to a position")
	language.Add("tool.npctool_controller.right","Possess the selected NPC")
