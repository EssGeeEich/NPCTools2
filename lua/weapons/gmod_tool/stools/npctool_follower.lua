...
if(CLIENT) then
	...
	language.Add("tool.npctool_follower.left","Select a NPC")
	language.Add("tool.npctool_follower.right","Make the selected NPCs follow a target")
	language.Add("tool.npctool_follower.reload","Make the selected NPCs follow yourself")
