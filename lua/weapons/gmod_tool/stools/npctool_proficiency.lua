...
if(CLIENT) then
	...
	language.Add("tool.npctool_proficiency.left","Change a NPC's proficiency")
	language.Add("tool.npctool_proficiency.right","Change all active NPCs of this class' proficiency")
