...
if(CLIENT) then
	...
	language.Add("tool.npctool_relationships.left","Select a source NPC or Player")
	language.Add("tool.npctool_relationships.right","Apply the relationship to the target")
	language.Add("tool.npctool_relationships.reload","Set yourself as the target")
